...
<!-- Collapsable Form -->
<div class="card mb-4 collapse hide border-reurb" id="form_equipe" style="max-width:800px">
    <!-- Card Header - Accordion -->
    <div class="card-header py-2 card-body bg-gradient-reurb align-middle" style="min-height: 2.5rem;">               
