                        ...
                        <div class="card mb-4 border-primary" id="form_usuario" style="max-width:900px">
                            ...
                            <div class="card-body">
                                <div class="alert alert-danger collapse fade hide" id="alerta">
                                    <span id="notificacao">Senha está diferente da confirmação!</span>
                                    <button type="button" class="close" data-toggle="collapse" data-target="#alerta" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form id="form_cadastro" action="save_senha_usuario.php" method="post" onsubmit="return validar();">
                                    <input type="hidden" id="id" name="id" value="<?= $usuario_logado->id ?>"/>
                                    ...
                                    <div class="form-group row">
                                        <label for="c_senha" class="col-sm-2 col-form-label">Confirma Senha:</label>
                                        <div class="col-sm-10">
                                            <input type="password" name="c_senha" class="form-control form-control-sm" id="c_senha" required>
                                        </div>
                                    </div>
